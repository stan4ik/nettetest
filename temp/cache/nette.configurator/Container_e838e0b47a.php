<?php
// source: D:\OSPanel\home\nette.loc/config/common.neon
// source: D:\OSPanel\home\nette.loc/config/services.neon
// source: array
...
class Container_e838e0b47a extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\UI\User\UserPresenter' => [2 => ['application.4']],
	...
	{
		return new App\UI\Accessory\FormFactory;
	}
	...
	public function createServiceApplication__4(): App\UI\User\UserPresenter
	{
		$service = new App\UI\User\UserPresenter($this->getService('02'), $this->getService('03'));
		$service->injectPrimary(
			$this->getService('http.request'),
			$this->getService('http.response'),
			$this->getService('application.presenterFactory'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'D:\OSPanel\home\nette.loc/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('D:\OSPanel\home\nette.loc/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('D:\OSPanel\home\nette.loc/temp/cache', $this->getService('cache.journal'));
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=mysql-8.2:3306;dbname=nettedb', /*sensitive{*/'root'/*}*/, null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_e838e0b47a $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('D:\OSPanel\home\nette.loc/temp/cache/latte');
